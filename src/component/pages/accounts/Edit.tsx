		...
		<form onSubmit={e => {
			...
			<div className={styles.container}>
				<div className={styles.header}>
					<img src={profileImg} alt='profile' width='70' height='70' style={{borderRadius: 50}} />
				...
				<div className="website_wrapper">
					...
					<div>
						<textarea id='introduce' maxLength={150} cols={40} rows={3} defaultValue={getUserInfo.bio} />
						<div>
							<span>{getUserInfo.bio.length}</span>{' '}<span>/</span>{' '}<span>150</span>
						</div>
					</div>
				</div>
				...
				<div className={styles.phone_number_wrapper}>
					...
					<input type='tel' id='phone_number' defaultValue={getUserInfo.phone_number}/>
				</div>
